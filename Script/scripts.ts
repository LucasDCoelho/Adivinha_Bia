...
let showTry = document.getElementById('tries') as HTMLSpanElement;
let showTryLost = document.getElementById('tries_lost') as HTMLSpanElement;
let showTryWin = document.getElementById('tries_win') as HTMLSpanElement;
let result = document.getElementById('random_number') as HTMLSpanElement;
...
if (showTryWin) {
    result.innerText = `${localStorage.getItem("randomNumber") as string}`
    showTryWin.innerText = `${localStorage.getItem("win") as string}`;
}

if (showTryLost) {
    result.innerText = `${localStorage.getItem("randomNumber") as string}`
    showTryLost.innerText = `${localStorage.getItem("lost") as string}`;
}
